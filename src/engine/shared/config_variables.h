...
MACRO_CONFIG_INT(SvDrawDistanceX, sv_draw_distance_x, 1000, 0, 5000, CFGFLAG_SERVER, "Draw distance X axis, 0 to 5000")
MACRO_CONFIG_INT(SvDrawDistanceY, sv_draw_distance_y, 900, 0, 5000, CFGFLAG_SERVER, "Draw distance Y axis, 0 to 5000")
MACRO_CONFIG_INT(SvDrawDistanceRadius, sv_draw_distance_radius, 1100, 0, 5000, CFGFLAG_SERVER, "Draw distance outer radius, 0 to 5000")
#endif
